    ...
    <main>
      ...
      <section className="page-hero" style={{background:"linear-gradient(135deg, #6B0000 0%, #3a0000 50%, #1a0000 100%)"}}>
        <div className="page-hero-inner">
          ...
          <div className="page-hero-visual"><ResponsiveMedia asset={legacyAsset} priority sizes="(min-width: 1050px) 40vw, 100vw" /></div>
        </div>
      </section>

      <section className="legacy">
        <div className="legacy-photo"><ResponsiveMedia asset={legacyAsset} sizes="(min-width: 1050px) 50vw, 100vw" /></div>
