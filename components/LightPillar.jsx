...
// LightPillar（React Bits）：Three.js 光线柱 shader 效果。
// 适配说明：
// - 加 "use client"（Next.js App Router 需要）
// - WebGL 不支持时渲染空白容器（不显示英文 fallback 文字）
// - 颜色由调用处传入主题红金色（topColor 金 / bottomColor 深红）
...
const LightPillar = ({
  ...
  if (!webGLSupported) {
    // WebGL 不可用时渲染空白容器（背景装饰缺席即可，不显示英文提示）
    return (
      <div
